...
export const metadata: Metadata = {
  ...
  description: "Curated hotel-quality kitchen essentials. Marble boards, trivets, dish towels, and more.",
};

export default function HotelKitchenPage() {
  const products = getProductsByRoom("kitchen");
        ...
        <section className="bg-white border-b border-border">
          <div className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
            ...
            <p className="mt-4 text-muted text-base font-sans max-w-xl leading-relaxed">
              The countertop details that make a kitchen feel elevated — marble boards,
              stone crocks, linen towels, and considered organizers.
            </p>
          </div>
        </section>
