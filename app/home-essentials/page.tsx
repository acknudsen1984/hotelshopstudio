...
export const metadata: Metadata = {
  ...
  description: "Curated home essentials. Candles, vases, trays, storage, and more.",
};

export default function HomeEssentialsPage() {
  const products = getProductsByRoom("home-essentials");
        ...
        <section className="bg-white border-b border-border">
          <div className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
            ...
            <p className="mt-4 text-muted text-base font-sans max-w-xl leading-relaxed">
              The objects that make a home feel alive — candles, ceramics, trays, storage,
              and small things worth owning well.
            </p>
          </div>
        </section>
